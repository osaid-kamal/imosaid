  ...
  return (
    <div id="projects">
      ...
      <div className="mt-14 mx-4 lg:mt-14 text-center grid grid-cols-1 lg:grid-cols-2 sm:grid:cols-2 hd gap-14  md:ml-70 sm:grid-cols-2 lg:ml-96">
        <div className="w-90 ml-19 border-500  hover:border-t-4 drop-shadow-lg rounded-lg lg:h-56 lg:ml-64 lg:mt-12 md:mt-8">
        ...
        <div className=" hover:border-t-4 drop-shadow-lg hover:drop-shadow-lg rounded-lg mt-5 lg:8:56 lg:mt-8 md:mt-8">
        ...
        <div className="hover:border-t-4 drop-shadow-lg hover:drop-shadow-lg rounded-lg lg:h-56 mt-5 lg:ml-64 mb-16">
          <h2>Price Tracker</h2>
          <p>
